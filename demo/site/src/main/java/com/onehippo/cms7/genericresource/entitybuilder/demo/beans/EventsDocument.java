...
@HippoEssentialsGenerated(internalName = "hippoaddongenericresourceentitybuilderdemo:eventsdocument")
@Node(jcrType="hippoaddongenericresourceentitybuilderdemo:eventsdocument")
public class EventsDocument extends HippoDocument {

    /**
     * The document type of the events document.
     */
    public final static String DOCUMENT_TYPE = "hippoaddongenericresourceentitybuilderdemo:eventsdocument";
    ...
    private final static String END_DATE = "hippoaddongenericresourceentitybuilderdemo:enddate";
     ...
     * @return the end date
     */
    @HippoEssentialsGenerated(internalName = "hippoaddongenericresourceentitybuilderdemo:enddate")
