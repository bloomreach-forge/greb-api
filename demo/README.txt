...
After your project is set up, access the CMS at <http://localhost:8080/cms> and the site at <http://localhost:8080/grebapidemo>.
...
as org.example/grebapidemo:3.0.1-SNAPSHOT
